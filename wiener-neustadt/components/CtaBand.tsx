    ...
    <section aria-label={cta.title} className="relative overflow-hidden border-t border-line py-section">
      ...
      <Reveal className="mx-auto max-w-2xl px-5 text-center sm:px-8">
        <p className="font-script text-3xl text-gold-soft">
          <span className="float-slow inline-block">{cta.script}</span>
        </p>
        ...
        <div className="mt-9 flex flex-wrap items-center justify-center gap-4">
          <Link
            href="/reservierung"
            className="btn-sheen rounded-full bg-gold px-8 py-4 font-semibold text-onAccent shadow-lg shadow-black/30 transition-all duration-300 hover:bg-gold-soft hover:shadow-[0_0_36px_rgba(198,161,91,0.4)] active:scale-[0.98]"
          >
            {cta.button}
          </Link>
          <a
