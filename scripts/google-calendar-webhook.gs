/**
 * Chen's Cooking — Google-Kalender-Webhook
 *
...
function doPost(e) {
  try {
    ...
    // Anmerkung kommt je nach Formular als "notes" oder "message"
    ...
    var description =
      ...
      (notes ? "\nAnmerkungen: " + notes : "") +
      "\n\nAngefragt über die Website — bitte per Telefon oder E-Mail bestätigen.";

    CalendarApp.getDefaultCalendar().createEvent(title, start, end, {
      description: description,
      location: "Chen's Cooking, Alphapark, Határdomb út 1-2, 9400 Sopron, Ungarn",
    });
