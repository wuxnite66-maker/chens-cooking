  ...
  takeaway: {
    ...
    categories: [
      ...
      },
      {
        ...
        items: [
          { code: "H17", name: "Gemüse-Ramen", price: "3590", desc: "scharf, chin. Eiernudeln" },
          { code: "H18", name: "Gemüse-Udon", price: "3590", desc: "Weizennudeln" },
          { code: "H18A", name: "Enten-Ramen", price: "4090", desc: "" },
          { code: "H19", name: "Meeresfrüchte-Ramen", price: "4090", desc: "scharf, chin. Eiernudeln" },
          { code: "H20", name: "Meeresfrüchte-Udon", price: "4090", desc: "mit Soja gewürzte Nudeln" },
        ],
      },
      {
        name: "Beilagen",
      ...
      },
      {
        ...
        note: "",
        items: [
          { code: "H24", name: "Exotische Früchteplatte", price: "1890", desc: "" },
          { code: "H25", name: "Lychee Kompott", price: "1890", desc: "" },
          { code: "H26", name: "Gebackene Früchte mit Honig & Sesam", price: "1890", desc: "Banane, Ananas oder Apfel nach Wahl" },
          { code: "H27", name: "Pudding", price: "1890", desc: "Kokos" },
      ...
      },
      {
        ...
        note: "",
        items: [
          { code: "S1", name: "Sushi-Set klein", price: "3690", desc: "6 Stück + 4 Maki" },
          { code: "S2", name: "Sushi-Set mittel", price: "4190", desc: "8 Stück + 4 Maki" },
          { code: "S3", name: "Sushi-Set groß", price: "4690", desc: "10 Stück + 4 Maki" },
          { code: "S4", name: "Sake-Set", price: "4190", desc: "8 Stück + 3 Maki; nur Lachs" },
          { code: "S5", name: "Sake-Set", price: "4690", desc: "10 Stück + 3 Maki; nur Lachs" },
          { code: "S6", name: "Maguro-Set", price: "4790", desc: "8 Stück + 3 Maki; nur Thunfisch" },
          { code: "S7", name: "Sake-Maguro-Set", price: "4590", desc: "8 Stück + 3 Maki" },
          { code: "S8", name: "Sake-Maguro-Set", price: "4790", desc: "10 Stück + 3 Maki" },
          { code: "S9", name: "Super-Mix", price: "3390", desc: "12 Stück: Lachs, Thunfisch, Gurke, Avocado" },
          { code: "S10", name: "Super-Mix", price: "4190", desc: "18 Stück: Lachs, Thunfisch, Gurke, Avocado" },
          { code: "S11", name: "Maki-Mix", price: "3190", desc: "12 Stück: Lachs, Thunfisch" },
          { code: "S12", name: "Maki-Mix", price: "3690", desc: "18 Stück: Lachs, Thunfisch" },
          { code: "S13", name: "Maki-Mix", price: "3190", desc: "12 Stück: Avocado, Gurke" },
          { code: "S14", name: "Maki-Mix", price: "3790", desc: "18 Stück: Avocado, Gurke" },
          { code: "S15", name: "Sake-Mix", price: "3190", desc: "12 Stück: mit Lachs" },
          { code: "S16", name: "Sake-Mix", price: "3790", desc: "18 Stück: mit Lachs" },
          { code: "S17", name: "Futomaki", price: "4490", desc: "10 Stück, dicke Rolle mit Surimi und Gemüse" },
          { code: "S18", name: "California-Maki", price: "4490", desc: "10 Stück, dicke Rolle mit Garnele, Surimi, Avocado" },
          { code: "S19", name: "Sushi Box", price: "10590", desc: "Sushi (14 Stück), California-Maki (10 Stück), Maki klein (8 Stück)" },
        ],
      },
      {
        name: "Saucen",
