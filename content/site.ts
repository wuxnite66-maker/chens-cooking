  ...
  takeaway: {
    ...
    categories: [
      ...
      },
      {
        ...
        note: "",
        items: [
          { code: "V6", name: "Vegetarische Frühlingsrolle", price: "890", desc: "5 Stück" },
          { code: "V8", name: "Champignon gebacken", price: "1090", desc: "" },
          { code: "V9", name: "Kyosa", price: "1090", desc: "5 Teigtaschen mit Fleisch und Gemüse gefüllt" },
          { code: "V10", name: "Sateh Ayam", price: "1190", desc: "2 Hühnerspießchen auf Salat" },
          { code: "V11", name: "Garnelenspießchen", price: "1190", desc: "3 Stück, auf Salat" },
        ],
      },
      {
        name: "Salate",
        note: "",
        items: [
          { code: "V12", name: "Pikanter Krautsalat", price: "990", desc: "" },
          { code: "V13", name: "Sojasprossen Salat", price: "990", desc: "" },
          { code: "V14", name: "Gurkensalat", price: "1090", desc: "" },
          { code: "V15", name: "Shrimps Salat", price: "1490", desc: "mit hausgemachter Cocktailsauce" },
          { code: "V16", name: "Gemischter Salat", price: "1190", desc: "" },
        ],
      },
      {
        name: "Hauptspeisen",
        note: "",
        items: [
          { code: "H1", name: "Meeresfrüchte mit rotem Curry", price: "3590", desc: "" },
          { code: "H2", name: "Knusprige Ente", price: "3490", desc: "" },
          { code: "H3", name: "Knusprige Ente mit Kostbarkeiten", price: "3790", desc: "im Gusstopf" },
          { code: "H4", name: "Knusprige Ente mit Mango", price: "3790", desc: "" },
          { code: "H5", name: "Gebratene Nudeln mit knuspriger Ente", price: "3190", desc: "mit Knoblauch- oder Currysauce" },
          { code: "H6", name: "Knuspriges Hühnerfilet", price: "2890", desc: "" },
          { code: "H7", name: "Sesam Chicken", price: "2890", desc: "" },
          { code: "H8", name: "Lemon Chicken", price: "2890", desc: "" },
          { code: "H9", name: "Kan-Bian Chicken", price: "2890", desc: "Wok-Hühnchen mit Gemüse, scharf" },
          { code: "H10", name: "Hühnerfleisch mit Bambus und Pilzen", price: "2890", desc: "" },
          { code: "H11", name: "Gebratene Nudeln mit knusprigem Hühnerfilet", price: "2890", desc: "" },
          { code: "H12", name: "Meeresfrüchte im Gusstopf", price: "3590", desc: "" },
          { code: "H13", name: "Kan-Bian Beef", price: "2890", desc: "Wok-Rind mit Gemüse, scharf" },
          { code: "H14", name: "Sa-Za Beef", price: "2890", desc: "Rindfleisch mit Brokkoli" },
          { code: "H15", name: "Gebratene Nudeln mit Hühnerfleisch", price: "2890", desc: "" },
          { code: "H16", name: "Gebratener Reis mit Hühnerfleisch", price: "2890", desc: "" },
        ],
      },
      {
        name: "Ramen & Udon",
      ...
      },
      {
        ...
        note: "",
        items: [
          { code: "H21", name: "Jasmin-Reis", price: "690", desc: "" },
          { code: "H22", name: "Gebratener Jasmin-Reis mit Eiern", price: "1090", desc: "" },
          { code: "H23", name: "Gebratene Nudeln mit Gemüse", price: "1190", desc: "" },
        ],
      },
      {
        name: "Nachspeisen",
