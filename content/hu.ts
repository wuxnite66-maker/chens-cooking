  ...
  takeaway: {
    ...
    categories: [
      ...
      },
      {
        ...
        note: "",
        items: [
          { code: "V6", name: "Vegetáriánus tavaszi tekercs", price: "1490", desc: "5 db" },
      ...
      },
      {
        ...
        note: "",
        items: [
          { code: "V12", name: "Kínai pikáns káposztasaláta", price: "1490", desc: "" },
          { code: "V13", name: "Szójacsíra saláta", price: "1590", desc: "" },
          { code: "V14", name: "Uborkasaláta", price: "1790", desc: "" },
          { code: "V15", name: "Rák saláta", price: "2090", desc: "helyben készített koktélszósszal" },
          { code: "V16", name: "Vegyes saláta", price: "1690", desc: "" },
        ],
      },
      {
        name: "Főételek",
        note: "",
        items: [
          { code: "H1", name: "Tenger gyümölcsei piros curryvel", price: "4890", desc: "" },
          { code: "H2", name: "Ropogós kacsa", price: "4790", desc: "" },
          { code: "H3", name: "Ropogós kacsa nyolcféle finomsággal", price: "5090", desc: "párolóedényben készült" },
          { code: "H4", name: "Ropogós kacsa mangóval", price: "5090", desc: "" },
          { code: "H5", name: "Pirított tészta ropogós kacsával", price: "4490", desc: "választható fokhagyma vagy curry szósszal" },
          { code: "H6", name: "Ropogós csirkehúsfalatok", price: "4190", desc: "" },
          { code: "H7", name: "Szezámmagos csirkehúsfalatok", price: "4190", desc: "" },
          { code: "H8", name: "Citromos csirkehúsfalatok", price: "4190", desc: "" },
          { code: "H9", name: "Kan-Bian csirke", price: "4190", desc: "WOK-ban készült zöldséges csirke, csípős" },
          { code: "H10", name: "Illatos-omlós csirke bambuszrüggyel és gombával", price: "4190", desc: "" },
          { code: "H11", name: "Pirított tészta ropogós csirkefalatokkal", price: "4190", desc: "" },
          { code: "H12", name: "Párolt tenger gyümölcsei", price: "4890", desc: "" },
          { code: "H13", name: "Kan-Bian marha", price: "5190", desc: "WOK-ban készült zöldséges marha, csípős" },
          { code: "H14", name: "Sa-Za Beef", price: "4190", desc: "marhahús brokkolival" },
          { code: "H15", name: "Pirított tészta omlós csirkehússal", price: "4190", desc: "" },
          { code: "H16", name: "Sült rizs omlós csirkehússal", price: "4190", desc: "" },
        ],
      },
      {
        name: "Ramen & Udon",
        ...
        items: [
          { code: "H17", name: "Ramen zöldséggel", price: "3590", desc: "csípős, kínai tojásos tészta" },
          { code: "H18", name: "Udon zöldséggel", price: "3590", desc: "búzalisztből készült tészta" },
          { code: "H18A", name: "Kacsa ramen", price: "4090", desc: "" },
          { code: "H19", name: "Ramen tenger gyümölcseivel", price: "4090", desc: "csípős, kínai tojásos tészta" },
          { code: "H20", name: "Udon tenger gyümölcseivel", price: "4090", desc: "szójával ízesített tészta" },
        ],
      },
      {
        name: "Köretek",
        note: "",
        items: [
          { code: "H21", name: "Jázmin rizs", price: "1190", desc: "" },
          { code: "H22", name: "Sült tojásos jázmin rizs", price: "1590", desc: "" },
          { code: "H23", name: "Pirított tészta zöldséggel", price: "1690", desc: "" },
        ],
      },
      {
        name: "Desszertek",
        note: "",
        items: [
          { code: "H24", name: "Vegyes egzotikus gyümölcsök", price: "1890", desc: "" },
          { code: "H25", name: "Lychee kompót", price: "1890", desc: "" },
          { code: "H26", name: "Sült gyümölcsök mézzel és szezámmal", price: "1890", desc: "választható: banán, ananász, alma" },
          { code: "H27", name: "Puding", price: "1890", desc: "kókusz" },
          { code: "H28", name: "Tiramisu", price: "1890", desc: "" },
        ],
      },
      {
        name: "Sushi",
        note: "",
        items: [
          { code: "S1", name: "Sushi szett kicsi", price: "3690", desc: "6 db + 4 db maki" },
          { code: "S2", name: "Sushi szett közepes", price: "4190", desc: "8 db + 4 db maki" },
          { code: "S3", name: "Sushi szett nagy", price: "4690", desc: "10 db + 4 db maki" },
          { code: "S4", name: "Sake szett", price: "4190", desc: "8 db + 3 db maki; csak lazac" },
          { code: "S5", name: "Sake szett", price: "4690", desc: "10 db + 3 db maki; csak lazac" },
          { code: "S6", name: "Maguro szett", price: "4790", desc: "8 db + 3 db maki; csak tonhal" },
          { code: "S7", name: "Sake-Maguro szett", price: "4590", desc: "8 db + 3 db maki" },
          { code: "S8", name: "Sake-Maguro szett", price: "4790", desc: "10 db + 3 db maki" },
          { code: "S9", name: "Super-Mix", price: "3390", desc: "12 db: lazac, tonhal, uborka, avokádó" },
          { code: "S10", name: "Super-Mix", price: "4190", desc: "18 db: lazac, tonhal, uborka, avokádó" },
          { code: "S11", name: "Maki-Mix", price: "3190", desc: "12 db: lazac, tonhal" },
          { code: "S12", name: "Maki-Mix", price: "3690", desc: "18 db: lazac, tonhal" },
          { code: "S13", name: "Maki-Mix", price: "3190", desc: "12 db: avokádó, uborka" },
          { code: "S14", name: "Maki-Mix", price: "3790", desc: "18 db: avokádó, uborka" },
          { code: "S15", name: "Sake-Mix", price: "3190", desc: "12 db: lazaccal" },
          { code: "S16", name: "Sake-Mix", price: "3790", desc: "18 db: lazaccal" },
          { code: "S17", name: "Futomaki", price: "4490", desc: "10 db, vastag tekercs surimivel és zöldséggel" },
          { code: "S18", name: "California-Maki", price: "4490", desc: "10 db, vastag tekercs garnélával, surimivel, avokádóval" },
          { code: "S19", name: "Sushi Box", price: "10590", desc: "Sushi (14 db), California-Maki (10 db), kis maki (8 db)" },
        ],
      },
      {
        name: "Szószok",
